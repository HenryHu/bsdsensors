...
std::map<NuvotonTempSource, uint8_t> kW83667HGATempSource{
...
const NuvotonChipInfo kW83667HGA = {
    .device_id_to_name = {
        {0xB351, "W83667HG-A rev. A"},
        {0xB352, "W83667HG-A rev. B"},
        {0xB353, "W83667HG-A rev. C"},
    },
    ...
    .fans = {
        {
            ...
            .control = NuvotonFanControlInfo{
                .mode_select = {9, 0x50, {0}, {0, 0x04, {3, 2}}},
        ...
        },
        {
            ...
            .control = NuvotonFanControlInfo{
                .mode_select = {0xA, 0x50, {0}, {0, 0x04, {5, 4}}},
        ...
        },
        {
            ...
            .control = NuvotonFanControlInfo{
                .mode_select = {0xB, 0x50, {0},{0, 0x12, {2, 1}}},
    ...
    .temp_table = kW83667HGATempSource,
    .temps = {
...
RegisterChip<NuvotonChipInfo> kRegisterW83667HGA(kW83667HGA);
