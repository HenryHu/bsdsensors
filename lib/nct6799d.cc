/*
 * nct6799d.cc
 * Copyright (C) 2026 Vincent Landgraf
 *
 * Distributed under terms of the 3-clause BSD license.
 */

// NCT6799D-R support (chip ID 0xd802)
// Register layout is identical to NCT6796D with the following differences:
//   - Additional AUXTIN4 temperature source (source index 7)
//   - 18 voltage inputs (vs 16 for NCT6796D)
//   - 7 fans (same as NCT6796D)
// Reference: Linux drivers/hwmon/nct6775-core.c, nct6799 structs

#include "nuvoton_chip_info.h"

namespace bsdsensors {

std::map<NuvotonTempSource, uint8_t> kNCT6799DTempSource{
...
const NuvotonChipInfo kNCT6799D = {
    .device_id_to_name = {
        {0xD802, "NCT6799D-R"},
    },
    ...
    .temp_table = kNCT6799DTempSource,
    .temps = {
...
RegisterChip<NuvotonChipInfo> kRegisterNCT6799D(kNCT6799D);
