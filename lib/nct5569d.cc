...
std::map<NuvotonTempSource, uint8_t> kNCT5569DTempSource{
    {kSourceCPUTIN, 1},       {kSourceAUXTIN2, 2}, {kSourceAUXTIN0, 3},
    {kSourceAUXTIN1, 4},      {kSourcePECI0, 5},   {kSourcePECI1, 6},
    {kSourceVirtualTemp1, 7}, {kSourceVirtualTemp2, 7}, {kSourceVirtualTemp3, 7},
};
