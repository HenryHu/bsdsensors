    ...
    .fans = {
        {
            ...
            .control = NuvotonFanControlInfo{
                ...
                .output_value_write = {0, 0x01}, // done
                .output_value_write_dc = {0, 0x01, {7, 2}}, // done
                .support_dc = true, // done
                .output_type = {0, 0x04, {0}},
                .output_value_read = {0, 0x01}, // done
